...
const Menubar = () => {
  ...
  return (
    <nav className="navbar bg-white px-5 py-4 d-flex justify-content-between align-items-center">
      <div className="div.d-flex.align-items-center gap-2">
      ...
      {userData ? (
          ...
          {dropdownOpen && (
            ...
            >
              {!userData.isAccountVerified && (
                <div
                  className="dropdown-item py-1 px-2 fw-semibold "
              ...
              <div
                className="dropdown-item py-1 px-2 text-danger fw-semibold"
                style={{ cursor: "pointer" }}
        ...
        <div
          className="btn btn-outline-dark rounded-pill px-3 fw-semibold"
